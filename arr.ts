...
// --------------Question no 06-------------//.
const lastFruit = fruits.pop(); // The pop() method is used for the removal of last element/item from the array.
console.log(fruits);
// output would be like that lastFruit = ["apple" , "banana" , "mango" , "orange"];
// Here's a magic done the last element vanished.

// --------------Question no 07--------------//.
const firstFruit = fruits.shift(); // The shift() method is used for the removal of the starting/first element/item from the array.
console.log(fruits);
...
// --------------Question no 11--------------//.
const citrusFruits = fruits.slice(0 , 2); // The slice() method is used for the creation of the new array from the existing array.
console.log(citrusFruits);
// output will be citrusFruits = ["kiwi" , "orange"];

// --------------Question no 12--------------//.
const lastTwoFruits = fruits.slice(-2); // The slice() method is also used for the creation of the new array from the existing array.
console.log(lastTwoFruits);
// output on execution would be lastTwoFruits = ["pineapple" , "pear"];
// Here you can see we are using the negative index in slice() method it's indicates the counting would starts from the end of the array.
